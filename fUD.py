...
def full_make_bond( Model, D, chi_boundry, chi_single, chi_try, d_in):
...
######################### No-symmetry #############################################
 if  Model[0] is "Heis"  or  Model[0] is "ITF" or Model[0] is "Fer" or Model[0] is "FFI" or Model[0] is "Fer_BOS":
  ...
  q_D, q_chi_boundry, q_chi_single, q_chi_try,q_d_in, q_d_out=make_bond(D, q_list, chi_boundry, chi_single, chi_try, qchi_boundry_list, qchi_single_list, qchi_try_list, d_in, q_list_out )
 ...
 if Model[0] is "Heis_Z2" or Model[0] is "ITF_Z2" or Model[0] is "Fer_Z2" or Model[0] is "FFI_Z2" or Model[0] is "Fer_BOS_Z2":
  ...
  q_D, q_chi_boundry, q_chi_single, q_chi_try,q_d_in=make_bond(D, q_list, chi_boundry, chi_single, chi_try, qchi_boundry_list, qchi_single_list, qchi_try_list, d_in)
...
#  q_list_out=[q_1_even,q0_even,q1_even]
  ...
  q_D, q_chi_boundry, q_chi_single, q_chi_try,q_d_in_try=make_bond(D, q_list, chi_boundry, chi_single, chi_try, qchi_boundry_list, qchi_single_list, qchi_try_list, d_in)
 ...
 return q_D, q_chi_boundry, q_chi_single, q_chi_try, q_d_in


def make_bond(D, q_list, chi_boundry, chi_single, chi_try, qchi_boundry_list, qchi_single_list, qchi_try_list, d_in):
 q_D=[]
 q_chi_boundry=[]
 q_chi_single=[]
 q_chi_try=[]
...
def Smo(N_x, i, j, Model):
 value_val=0
 if Model[2]=="off":
  value_val=1.0
 if Model[2]=="Sin":
  value_val=(math.sin((math.pi/N_x)*(i+1-0.5))**2)*(math.sin((math.pi/N_x)*(j+1-0.5))**2)
 if Model[2]=="Tanh":
  if i<j:
   value_val=smoth_f(N_x, i)
  else:
   value_val=smoth_f(N_x, j)

 return value_val


def SmoP(N_x, i, j, Model):
 value_val=0
 value_val=(smoth_f(N_x, i)+smoth_f(N_x, j))*0.5
 return value_val
...
def Sz_from_Density_direct( rho_col, Magz_col, N_x, Sys ):
 ...
 for i in xrange(N_x):
  for j in xrange((N_x)):
   ...
   #print i,j, rho_col1[i][j], Magz_col[i][j]
